...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="menu-inner py-1">
    ...
    <!-- Forms & Tables -->
    <li class="menu-header small text-uppercase"><span class="menu-header-text">User  &amp; Dashbourd</span></li>
    <!-- Forms -->
      ...
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="prsonal info">prsonal info</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('listAllPersonal') }}" class="menu-link">
            <div data-i18n="List_prsonal info">list prsonal info</div>
          </a>
        </li>
           <li class="menu-item">
          <a href="{{ route('addEdu') }}" class="menu-link">
            <div data-i18n="Add  prsonal info">Add  prsonal info</div>
          </a>
        </li>
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('listAllEdu') }}" class="menu-link">
            <div data-i18n="List education">list education</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{ route('addEdu') }}" class="menu-link">
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class='menu-icon tf-icons bx bx-food-menu'></i>
        <div data-i18n="experince">experince</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('listAllExp') }}" class="menu-link">
            <div data-i18n="List_experince">list experince</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{ route('addExp') }}" class="menu-link">
            <div data-i18n="Add experince">Add experince</div>
          </a>
        </li>
     ...
     <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('listAllCourse') }}" class="menu-link">
            <div data-i18n="List_course">list course</div>
          </a>
        </li>
        <li class="menu-item">
